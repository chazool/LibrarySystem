...
public class GUIUserLogin extends javax.swing.JFrame {
    ...
    private void ButLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButLoginActionPerformed
        ...
        UserManager userManagr = new UserManager();

        String UserName = txtUserName.getText().trim();
        String Password = txtPassword.getText().trim();

        boolean result = userManagr.Login(UserName, Password);

        if (result == true) {
            GUIHome guiHome = new GUIHome();
            guiHome.UserName = UserName;
            guiHome.setVisible(true);
            this.dispose();
        } else {
            lblMassage.setText("Invalid Password or UserName");
        }
